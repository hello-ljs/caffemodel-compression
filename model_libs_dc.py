...
def VGGNetBody(net, from_layer, need_fc=True, fully_conv=False, reduced=False,
    ...
    assert from_layer in net.keys()
    net.conv1_1  = L.Convolution(net[from_layer], num_output=34, pad=1, kernel_size=3, **kwargs)

    net.relu1_1  = L.ReLU(net.conv1_1, in_place=True)
    net.conv1_2  = L.Convolution(net.relu1_1, num_output=34, pad=1, kernel_size=3, **kwargs)
    net.relu1_2  = L.ReLU(net.conv1_2, in_place=True)

    if nopool:
        name = 'conv1_3'
        net[name] = L.Convolution(net.relu1_2 , num_output=92, pad=1, kernel_size=3, stride=2, **kwargs)
    else:
        name = 'pool1'
        net.pool1 = L.Pooling(net.relu1_2 , pool=P.Pooling.MAX, kernel_size=2, stride=2)

    net.conv2_1  = L.Convolution(net[name], num_output=61, pad=1, kernel_size=3, **kwargs)
    net.relu2_1  = L.ReLU(net.conv2_1 , in_place=True)
    net.conv2_2  = L.Convolution(net.relu2_1 , num_output=67, pad=1, kernel_size=3, **kwargs)
    ...
    net.conv3_1  = L.Convolution(net[name], num_output=135, pad=1, kernel_size=3, **kwargs)
    net.relu3_1  = L.ReLU(net.conv3_1 , in_place=True)
    net.conv3_2  = L.Convolution(net.relu3_1 , num_output=126, pad=1, kernel_size=3, **kwargs)
    net.relu3_2  = L.ReLU(net.conv3_2 , in_place=True)
    net.conv3_3  = L.Convolution(net.relu3_2 , num_output=131, pad=1, kernel_size=3, **kwargs)
    ...
    net.conv4_1  = L.Convolution(net[name], num_output=42, pad=1, kernel_size=3, **kwargs)
    net.relu4_1  = L.ReLU(net.conv4_1 , in_place=True)
    net.conv4_2  = L.Convolution(net.relu4_1 , num_output=71, pad=1, kernel_size=3, **kwargs)
    ...
    use_batchnorm=True
    use_relu=False
    ConvBNLayer(net,from_layer, out_layer, use_batchnorm, use_relu, 73, 3, 1, 1,lr_mult=lr_mult)
    ...
    kernel_size = 3
    pad =1
    net.conv5_1   = L.Convolution(net[name], num_output=80, pad=pad, kernel_size=kernel_size, **kwargs)
    net.relu5_1   = L.ReLU(net.conv5_1  , in_place=True)
    net.conv5_2  = L.Convolution(net.relu5_1  , num_output=86, pad=pad, kernel_size=kernel_size, **kwargs)
    net.relu5_2   = L.ReLU(net.conv5_2  , in_place=True)
    net.conv5_3   = L.Convolution(net.relu5_2  , num_output=73, pad=pad, kernel_size=kernel_size, **kwargs)
        ...
        if fully_conv:
            if dilated:
                ...
                if reduced:
                    ...
                    kernel_size = 3
                    num_output = 19
            pad = 1#int((kernel_size + (dilation - 1) * (kernel_size - 1)) - 1) / 2
            ...
            if reduced:
                net.fc7  = L.Convolution(net.relu6 , num_output=20, kernel_size=1, **kwargs)
            else:
                net.fc7  = L.Convolution(net.relu6 , num_output=20, kernel_size=1, **kwargs)
            net.relu7  = L.ReLU(net.fc7 , in_place=True)
            if dropout:
            ...
            if dropout:
                net.drop7  = L.Dropout(net.relu , dropout_ratio=0.5, in_place=True)
    
    '''name = 'pool5'
    net[name] = L.Pooling(net.relu5_3, pool=P.Pooling.MAX,pad=1, kernel_size=3, stride=1)
    net.fc6 = L.Convolution(net.pool5, num_output=86, pad=1, kernel_size=3, **kwargs)
    net.relu6 = L.ReLU(net.fc6, in_place=True)
